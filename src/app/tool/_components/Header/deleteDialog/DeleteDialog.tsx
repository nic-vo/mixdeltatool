	...
	const submitHandler = async (e: React.FormEvent) => {
		...
		try {
			const res = await fetch(
				`/api/account/${process.env.NEXT_PUBLIC_ACCOUNT_ROUTE_OBFUS}`
			);
		...
		<>
			{toggle && (
				<dialog
					...
					<p>
						This form will delete only your account and session data from
						MixDelta. It won&apos;t affect any playlists you&apos;ve already
						created with the tool. After using this tool, visit{' '}
						<a
					...
					<form
						...
						<label
							...
							To proceed with deletion, type &quot;mixdelta&quot; and press
							confirm.
							<input
								name='confirmation'
								id='confirmation'
